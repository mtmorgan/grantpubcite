...
‘Advanced’, and tow have matured from 'Advanced' to 'Sustained'. I was
...
explore the data. There are `r nrow(projects)` returned by NIH
Reporter, and each project is associated with funding over multiple
fiscal years and mechanisms (e.g., through administrative
supplements).
...
Direct inspection suggests the following:

```{r maturing projects}
tribble(
    ~contact_pi_name, ~from,         ~to,
    "Campbell",       "Early-Stage", "Innovative",
