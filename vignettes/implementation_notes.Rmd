...
[ggplot2][] and [plotly][] for figures, and [DT][] (wrapping the
JavaScript [datatables][] library) for interactive tables. The package
web site is made with [pkgdown][] using GitHub actions to update on
push. These are really amazing packages!
